...
def main(argv):
    ...
    parser.add_argument('-p', '--pretrainings', default='', help='path to the pretrainings model. Default: RobertaForMultipleChoice with roberta-large weights')
    ...
    raw_data_train = get_data_ndq(dataset_name, "train", tokenizer, max_len)
    raw_data_val = get_data_ndq(dataset_name, "val", tokenizer, max_len)
