...
def main(argv):
    ...
    parser.add_argument('-p', '--pretrainingslist', default=["checkpoints/tf_roberta_IR_e1.pth", "checkpoints/tf_roberta_NSP_e2.pth", "checkpoints/tf_roberta_NN_e1.pth"], help='list of paths of the pretrainings model. They must be three. Default: checkpoints/tf_roberta_IR_e1.pth, checkpoints/tf_roberta_NSP_e2.pth, checkpoints/tf_roberta_NN_e1.pth')
